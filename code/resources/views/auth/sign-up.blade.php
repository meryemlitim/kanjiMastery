...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-lg rounded-lg w-10/11 max-w-5xl flex">
        <!-- Left Side (Image) -->
        ...
        <div class="w-full md:w-3/5 flex flex-col items-center justify-center">
            ...
            <p class="text-gray-600 mb-6">Start your kanji learning journey now.</p>
            
            <form action="{{ route('signup_user') }}" method="POST" class="space-y-4 ">
                @csrf
                <div class="flex flex-col">

                    <input type="text" placeholder="First name" name="name" class="w-7/6 p-3 border rounded-md" value="{{ old('name') }}">
                ...
                <p class="text-center text-sm">Don’t have an account? <a href="#" class="text-pink-500">Log In</a></p>
            </form>
        </div>
    </div>
</body>
